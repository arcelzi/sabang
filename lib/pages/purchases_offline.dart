...
class PurchaseOffline extends StatefulWidget {
  ...
  @override
  State<PurchaseOffline> createState() => _PurchaseOfflineState();
}

class _PurchaseOfflineState extends State<PurchaseOffline> {
  ...
  Widget buildOfflineDataList() {
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
       var purchaseData = offlineDataList[index];
        return ListTile(
          title: Text('${purchaseData}'),
                          ...
                          child: Row(
                            ...
                            children: [
                              TextButton(
                                onPressed: () {
                                  // TODO upload
                                  uploadData(purchaseData);
                                  // delete
                                  offlineDataBox.delete(purchaseData['uid']);
                                }, 
                                child: const Text('Ya'),
                                ),
                                TextButton(
